...
if st.session_state.current_session_plates:
    ...
    # Display detected plates with time tracking, messaging, and auto feedback
    for idx, plate_data in enumerate(st.session_state.current_session_plates, 1):
        ...
        # 🌟 Auto Feedback Section (displayed prominently if generated)
            ...
            with st.form(key=f"message_form_{plate}"):
                ...
                if submit_button and new_msg.strip():
                    if save_message_to_db(plate, new_msg.strip()):
                        ...
                        st.warning("⚠️ Please check your database connection and try again.")
...
<div style="text-align: center; color: #666; padding: 20px;">
    ...
    <p>💰 <strong>Discount System:</strong> 5% off with loyalty card | 10% off on 10th visit</p>AI Satisfaction:</strong> Churn prediction model analyzes fuel costs to predict customer satisfaction</p>
    <p>💰 <strong>Discount System:</strong> 5% off with loyalty card | 10% off on 10th visit</p>AI Satisfaction:</strong> Churn prediction model analyzes fuel costs to predict customer satisfaction</p>
</div>
""", unsafe_allow_html=True)